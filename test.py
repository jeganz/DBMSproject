...
employeeframe=Tk()
employeeframe.geometry('750x450')
employeeframe.title('Add new employee')

heading=customtkinter.CTkLabel(employeeframe,text='Item Details',font=('Century Gothic', 18,'bold','underline'),width=100,text_color='black')
...
mytree = ttk.Treeview(employeeframe,columns=("id","name",'Category','Stock','Price'))
...
buttons('Modify Product',320,405,moditemicon,moditemicon2,delitem)
